...
public class FilePanel extends JPanel{
  ...
  public FilePanel(){
    ...
    String fileName = "Lab20data.txt"; // data field declarations
    boolean fillb = true;
    ...
    try{
      ...
      // loop repeats for each line in the file
      while (fileScan.hasNextLine()){
        int i = 0;
        
        // loop sets each item in the array to the ints read in from the file
        while (i < 6){
